...
import { Body1, Caption1, Checkbox, SearchBox, Subtitle2 } from "@fluentui/react-components";
...
export const FilterStage: React.FC = () => {
    ...
    return <>
        <div style={{display: "flex", flexDirection: "column", height: "100%"}}>
            <StageTitle title={t("filter.title")} icon={Filter24Regular} desc={t("filter.desc")} />
            <div>
